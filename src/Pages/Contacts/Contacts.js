...
import magnifierIcon from '../../assets/icons/magnifier.png'; // Add the path to the magnifier icon
import placeholderImage from '../../assets/icons/picture_placeholder.png'; // Add the path to the placeholder image
        ...
        fetch('https://siseveeb.voco.ee/veebilehe_andmed/tootajad?section=ALL')
            ...
            .then(data => {
                ...
                const formattedTeachers = itAkadeemiaTeachers.map(teacher => ({
                    ...
                    image: teacher.image || placeholderImage, // Use placeholder image if no image is available
                    ...
                    <div className="contact">
                        ...
                        <div className="contact-info">
                            ...
                            <div className="frame">
                                ...
                                <p className="bold">Tartu Rakenduslikule Kolledžile saab esitada üksnes e-arveid.</p>
                            </div>
                            <div className="frame">
